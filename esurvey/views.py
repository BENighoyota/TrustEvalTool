...
def getdata(request, project_id):
...
#function calculate crobanch alpha
   ...
   # 3. Use the formula to calculate Cronbach's Alpha
    ...
    if NumberOfSurveys==1:
        template='one.html' # the template
        ...
        for i in range(0, len(S1CountAge)):
            if S1CountAge[i] == "":
                S1CountAge[i]=0
            else:
...
#Riesk Q3 for both questioniares
        ...
        template='two.html' # the template
        #get the link ids for the two surveys
        LID1 = Link.objects.filter(survey_id=SID[0]).values_list('id', flat=True)
        ...
        for i in range(0, len(S2CountAge)):
            if S2CountAge[i] == "":
                S2CountAge[i]=0
            else:
...
#Riesk Q3 for both questioniares
        ...
        template='three.html' # the template
        #get the link ids for the two surveys
        LID1 = Link.objects.filter(survey_id=SID[0]).values_list('id', flat=True)
        LID2 = Link.objects.filter(survey_id=SID[1]).values_list('id', flat=True)
        ...
        for i in range(0, len(S3CountAge)):
            if S3CountAge[i] == "":
                S3CountAge[i]=0
            else:
                S3CountAge[i] = S3CountAge[i]
        #print(S1CountAge)
        #print(S2CountAge)
        #get all response for each survey
        allRespS1= Submission.objects.values('q1','q2','q3','q4','q5','q6','q7','q8','q9','q10','q11','q12','q13','q14').filter(Q(link_id=LID1[0])).all()
...
#Riesk Q2 for both questioniares
        ...
        if GtrustQ2S3s!=0:
            ...
            GtrustQ2S3s=0
#Riesk Q23 for both questioniares
        GtrustQ3S1= Submission.objects.aggregate(
            overaltrust=
                Sum("q14", filter=(Q(link_id=LID1[0])), output_field=FloatField()))
        GtrustQ3S2= Submission.objects.aggregate(
        ...
        template='four.html' # the template
        #get the link ids for the two surveys
        LID1 = Link.objects.filter(survey_id=SID[0]).values_list('id', flat=True)
        LID2 = Link.objects.filter(survey_id=SID[1]).values_list('id', flat=True)
        LID3 = Link.objects.filter(survey_id=SID[2]).values_list('id', flat=True)
        ...
        for i in range(0, len(S4CountAge)):
            if S4CountAge[i] == "":
                S4CountAge[i]=0
            else:
...
#Riesk Q3 for both questioniares
        ...
        template='five.html' # the template
        #get the link ids for the two surveys
        LID1 = Link.objects.filter(survey_id=SID[0]).values_list('id', flat=True)
        LID2 = Link.objects.filter(survey_id=SID[1]).values_list('id', flat=True)
        LID3 = Link.objects.filter(survey_id=SID[2]).values_list('id', flat=True)
        ...
        for i in range(0, len(S5CountAge)):
            if S5CountAge[i] == "":
                S5CountAge[i]=0
            else:
...
#Riesk Q1 for both questioniares
        ...
        if RiskQ1S5s!=0:
            RiskQ1S5s= (RiskQ1S5s*100) / (5*survey5Counts)
